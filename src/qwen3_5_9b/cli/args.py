...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="Qwen3.5-9B generate-then-optimize summarization experiments")
    parser.add_argument(
        "--method",
        required=True,
        choices=ALL_METHODS,
        help="Optimization method to run for this Qwen3.5-9B experiment directory.",
    )
    parser.add_argument(
        "--objective",
        default=None,
