"""Experiment orchestration for BART generate-then-optimize runs."""
...
def _run_experiment_impl(args) -> str:
    ...
    generation_title = "Llama-3.1-8B-Instruct Baseline" if is_generation_baseline else f"Llama-3.1-8B-Instruct Candidates-{beam_size}"
