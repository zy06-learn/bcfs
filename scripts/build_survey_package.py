#!/usr/bin/env python3
"""Build a static human-evaluation survey package.

The package is intentionally backend-free: annotators complete their assigned
items in the browser and export a CSV response file.
"""
...
def main() -> int:
    ...
    parser.add_argument("--annotations_per_item", type=int, default=3)
